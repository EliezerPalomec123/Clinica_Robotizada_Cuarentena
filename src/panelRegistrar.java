...
public class panelRegistrar extends javax.swing.JPanel {
    ...
    public panelRegistrar(javax.swing.JFrame ventana) {
        initComponents();
    ...
    private void initComponents() {
        ...
        buttonImportTable = new javax.swing.JLabel();
        ...
        add(txtMatricula, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 160, 270, 50));
        ...
        add(separadorMatricula, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 210, 280, 3));
        ...
        add(txtGrupo, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 300, 270, 50));
        ...
        add(separadorGrupo, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 350, 280, 3));
        ...
        jLabel1.setText("Registrar Alumno(s)_");
        ...
        buttonImportTable.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        buttonImportTable.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        buttonImportTable.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/xls.png"))); // NOI18N
        buttonImportTable.setText("Importar ");
        buttonImportTable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        buttonImportTable.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        buttonImportTable.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        buttonImportTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                buttonImportTableMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                buttonImportTableMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                buttonImportTableMouseExited(evt);
            }
        });
        add(buttonImportTable, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 70, 90, 110));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, 280, 40));

        jLabel7.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(43, 113, 205));
        jLabel7.setText("Grupo:");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 250, 280, 40));
    ...
    private void buttonImportTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonImportTableMouseClicked
        InterfaceAdministrador.panelActivo=pnlImportarExcel;
        this.setVisible(false);        
        pnlImportarExcel.setVisible(true);
        pnlImportarExcel.importarExcelATabla();
    }//GEN-LAST:event_buttonImportTableMouseClicked

    private void buttonImportTableMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonImportTableMouseEntered
        buttonImportTable.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/xls(1).png"))); // NOI18N
        buttonImportTable.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    }//GEN-LAST:event_buttonImportTableMouseEntered

    private void buttonImportTableMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonImportTableMouseExited
        buttonImportTable.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos/xls.png"))); // NOI18N
        buttonImportTable.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
    }//GEN-LAST:event_buttonImportTableMouseExited
    ...
    private void buttonRegistrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonRegistrarMouseClicked
        ...
        if(esValidoTxt(txtNombre,separadorNombre) && esValidoTxt(txtApellidoPaterno,separadorApellidoPaterno) && esValidoTxt(txtApellidoMaterno,separadorApellidoMaterno) && esValidoTxt(txtMatricula,separadorMatricula) && esValidoTxt(txtGrupo,separadorGrupo)){
            if(JOptionPane.showConfirmDialog(this, "¿Esta seguro que desea registrar el Alumno?", "Confirmar", JOptionPane.YES_NO_OPTION)==0){
                //System.out.println("Hola");
                grupo=txtGrupo.getText();
                if(MatValida(txtMatricula.getText()))
                    try {
                          ...
                          String resul=Splash.conexionBaseDatos.CallProcVal(txtMatricula.getText(),txtNombre.getText(),txtApellidoPaterno.getText(),txtApellidoMaterno.getText());
                          if(resul!=null)
                            if(Integer.parseInt(resul)==1062)
                              JOptionPane.showMessageDialog(null,"Ya existe un alumno con esa Matrícula");
                    } catch (SQLException ex) {
                        Logger.getLogger(panelRegistrar.class.getName()).log(Level.SEVERE, null, ex);
                    }
                else if(!MatValida(txtMatricula.getText()))
                    JOptionPane.showMessageDialog(null,"La matricula no es valida");
                
                if(isImpar(grupo))
                    Splash.conexionBaseDatos.InsertTableInscrito(txtMatricula.getText(),"001",txtGrupo.getText());
                    
                else
                    Splash.conexionBaseDatos.InsertTableInscrito(txtMatricula.getText(),"002",txtGrupo.getText());
    ...
    private javax.swing.JLabel buttonImportTable;
